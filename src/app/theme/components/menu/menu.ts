...
export const verticalMenuItems = [
    new Menu(1, 'Dashboard', '/', null, 'dashboard', null, false, 0, ['admin']),
    new Menu(2, 'Users', '/users', null, 'supervisor_account', null, false, 0, ['admin']),
    new Menu(3, 'Servers', '/servers', null, 'domain', null, false, 0, ['admin']),
    new Menu(19, 'Clients', '/clients', null, 'domain', null, false, 0, ['admin']),
    new Menu(37, 'Roles', '/roles', null, 'domain', null, false, 0, ['admin']),
    ...
    new Menu(7, 'Grids', '/ui/grids', null, 'grid_on', null, false, 18, []),
    new Menu(8, 'Tabs', '/ui/tabs', null, 'tab', null, false, 18, []),
    new Menu(9, 'Expansion Panel', '/ui/expansion-panel', null, 'dns', null, false, 18, []),
    new Menu(10, 'Chips', '/ui/chips', null, 'label', null, false, 18, []),
    new Menu(11, 'Progress', '/ui/progress', null, 'data_usage', null, false, 18, []),
    new Menu(12, 'Dialog', '/ui/dialog', null, 'open_in_new', null, false, 18, []),
    new Menu(13, 'Tooltip', '/ui/tooltip', null, 'chat_bubble', null, false, 18, []),
    new Menu(14, 'Snackbar', '/ui/snack-bar', null, 'sms', null, false, 18, []),
    new Menu(15, 'Dynamic Menu', '/dynamic-menu', null, 'format_list_bulleted', null, false, 0, ['admin']),
...
export const horizontalMenuItems = [
    ...
    new Menu(73, 'Line Charts', '/charts/line', null, 'show_chart', null, false, 70, []),
    new Menu(74, 'Bubble Charts', '/charts/bubble', null, 'bubble_chart', null, false, 70, []),
    new Menu(81, 'Drag & Drop', '/drag-drop', null, 'mouse', null, false, 18, []),
    new Menu(85, 'Material Icons', '/icons', null, 'insert_emoticon', null, false, 18, []),
    new Menu(40, 'Pages', null, null, 'library_books', null, true, 0, []),
    new Menu(43, 'Login', '/login', null, 'exit_to_app', null, false, 40, []),
    new Menu(44, 'Register', '/register', null, 'person_add', null, false, 40, []),
    new Menu(45, 'Blank', '/blank', null, 'check_box_outline_blank', null, false, 40, []),
